...
### 🔍 Key Finding
> **Ethnicity DPD = 1.0** — the maximum possible value.  
> Native candidates received predicted hire rates of **100%** while Ukrainian and other non-native candidates received **near-zero** positive predictions regardless of gender — a 100 percentage point intersectional gap.
